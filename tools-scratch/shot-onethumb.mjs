...
await d.screenshot({ timeout: 120000, path: '/tmp/claude-0/-home-user-racing-shooter/0a1b4850-fdd3-5cf2-92f1-b12f6b9663b9/scratchpad/hud-desktop2.png' });
await d.close();
...
await new Promise((r) => setTimeout(r, 6000));
await m.screenshot({ timeout: 120000, path: '/tmp/claude-0/-home-user-racing-shooter/0a1b4850-fdd3-5cf2-92f1-b12f6b9663b9/scratchpad/hud-onethumb.png' });
await browser.close();
