...
| **7.14 Evergreens (owner, 2026-09-08)** | "Pine trees are never not green. They are evergreen. Apply this across the game." Every pine-silhouette tree (pineA, pineB, fir — any stacked-cone/skirt conifer) renders green foliage on EVERY palette: autumn, harvest, moor, volcano, snow, dusk — no theme band, season, or altitude paint may tint a pine's needles off green. The r393 conifer tint law (sheet green #236555 divided through the canopy material, every theme) is the implement; every new tree system, imposter, or horizon painting that depicts conifers is bound by it. LARCH IS BOUND TOO (screenshot census, r397: the yellow spiky trees on the autumn worlds ARE the non-green pines of the owner's report — the larch's tiered cones read as a pine at game scale); it keeps its own paler yellow-GREEN band, theme-independent. Broadleaf lobed crowns (maple, oak, birch, poplar) carry the autumn colours; a cold-light cast on green needles (FROST PEAK) is lighting, not a violation |
