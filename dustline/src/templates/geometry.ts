...
// ---------------------------------------------------------------------------
// PRIMITIVES — base-anchored boxes, cylinders, cones and spheres.
//
// Moved here from `world/props/types.ts`, where they sat at the bottom of the
// file that defines what a component is. Same functions, same numbers; they
// are re-exported from there so no component file had to change.
// ---------------------------------------------------------------------------
