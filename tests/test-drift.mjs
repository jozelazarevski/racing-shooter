...
const R = await p.evaluate(() => {
  ...
  return { d70: run(true, 70), p70: run(false, 70), d110: run(true, 110) };
});
...
ok(R.d70.turn > R.p70.turn * 1.8,
  'drifting turns the car decisively harder than gripping at the same speed',
  `drift ${R.d70.turn.toFixed(0)}° vs grip ${R.p70.turn.toFixed(0)}°`);
