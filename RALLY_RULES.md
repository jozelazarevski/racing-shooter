...
| E-9 | "Add hazards and obstacles to Dodge and blow up across the tracks" (2026-09-10, frame r409 CANYON RUN) | More to DODGE and more to DESTROY, roster-wide. Read as two classes, because one of them collides with a hard rule (K-12): (a) DESTRUCTIBLE hazards the player blows up — explosive barrels, stacks, drums, fuel cans — which already have machinery (`flyingProps`, the smash/shove classes, the debris path) and which §7.3 permits off the driving surface; (b) DODGEABLE hazards that reach the carriageway WITHOUT standing in it: rockfall that arrives, rolling boulders, crossing traffic, a barrel that bursts and scatters. What this rule does NOT authorise is a static body parked in the racing line — HRD-1 forbids exactly that and the owner has filed it as a defect before (r361, "striped object mid-road. Fix"). Density and placement follow §7.3 (<= 1 per 20 m in the 4-12 m band, none within 4 m of the course line, no rocks in street segments) and kicker landing zones stay clear. | OPEN |
