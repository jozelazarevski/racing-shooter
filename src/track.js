...
const CIRCUITS = {
  ...
  rbring: [ // Red Bull Ring — three big straights, hilltop rights, flowing left sweeps home
    [96.3, 118.5], [58.8, 129.4], [20.4, 139.7], [-17.3, 145.2], [-51.4, 138.1],
    [-80.0, 115.9], [-104.7, 84.6], [-127.6, 51.0], [-148.8, 16.6], [-169.0, -18.2],
    [-191.5, -51.9], [-216.8, -83.2], [-235.0, -110.7], [-232.1, -131.5], [-205.9, -142.7],
    [-167.4, -145.2], [-126.5, -142.0], [-85.8, -136.6], [-44.7, -131.5], [-4.2, -126.9],
    [28.5, -118.0], [40.8, -100.9], [26.4, -81.6], [-6.7, -70.3], [-46.0, -66.1],
    [-80.8, -57.9], [-100.0, -37.1], [-97.3, -7.7], [-76.4, 15.9], [-45.9, 20.7],
    [-12.0, 8.4], [24.3, -6.9], [64.0, -15.3], [106.1, -17.9], [148.5, -18.1],
    [188.1, -13.9], [219.4, 1.7], [235.0, 29.1], [229.9, 58.7], [205.6, 81.2],
    [170.6, 96.1], [133.3, 107.7],
  ],
  monaco: [ // Monaco — Ste Devote, the climb to Casino, Loews, the tunnel sweep, Rascasse
    [197.0, -133.0], [170.5, -128.6], [144.4, -110.9], [125.6, -84.9], [110.7, -58.5],
    [88.6, -42.0], [56.8, -39.5], [20.8, -44.3], [-16.1, -50.1], [-52.6, -56.6],
    [-88.6, -64.4], [-123.4, -70.1], [-155.0, -66.1], [-180.9, -47.6], [-201.2, -18.7],
    [-217.1, 14.0], [-228.9, 48.2], [-235.0, 82.9], [-231.5, 113.8], [-218.4, 133.0],
    [-207.3, 129.3], [-202.2, 112.0], [-199.4, 81.8], [-190.3, 49.7], [-179.2, 16.7],
    [-166.8, -15.1], [-146.6, -38.3], [-117.5, -46.4], [-84.4, -41.0], [-50.5, -30.0],
    [-16.4, -20.3], [18.5, -14.0], [54.5, -9.1], [91.7, -5.4], [129.0, -6.1],
    [164.3, -14.5], [195.2, -32.0], [220.0, -57.3], [235.0, -84.8], [234.5, -108.0],
    [219.6, -124.5],
  ],
  silverstone: [ // Silverstone — Copse, the Maggotts/Becketts esses, Stowe, Club
    [138.4, -120.2], [163.5, -117.1], [190.8, -100.3], [211.6, -73.8], [225.7, -41.9],
    [234.6, -8.3], [235.0, 23.5], [221.4, 49.8], [195.0, 68.3], [162.5, 81.0],
    [128.8, 91.7], [95.4, 102.1], [62.2, 112.2], [29.2, 119.9], [-2.7, 120.2],
    [-33.9, 110.9], [-65.9, 97.4], [-99.2, 85.4], [-133.2, 75.0], [-167.3, 64.9],
    [-200.2, 53.3], [-226.0, 37.1], [-235.0, 14.7], [-224.6, -11.8], [-206.2, -40.4],
    [-191.4, -69.8], [-178.4, -95.5], [-157.8, -109.2], [-128.5, -107.3], [-96.4, -95.2],
    [-65.5, -79.1], [-39.4, -58.2], [-19.8, -31.1], [-2.8, -1.5], [12.4, 26.7],
    [21.1, 51.2], [28.7, 66.9], [46.5, 67.2], [71.3, 51.4], [93.6, 25.2],
    [112.6, -4.8], [129.0, -35.5], [137.2, -64.5], [133.2, -89.9], [128.2, -109.6],
  ],
  spa: [ // Spa — La Source, the Eau Rouge climb, Kemmel, and a long flowing east side
    [-141.7, -15.4], [-110.6, -36.0], [-79.2, -55.5], [-47.4, -73.9], [-14.4, -89.7],
    [19.4, -103.3], [53.5, -116.2], [87.7, -128.4], [121.8, -137.8], [155.8, -142.0],
    [189.0, -138.5], [218.0, -124.8], [235.0, -104.9], [232.6, -91.1], [211.9, -87.7],
    [181.0, -85.0], [147.0, -76.6], [116.0, -62.6], [97.8, -41.6], [101.1, -17.1],
    [124.0, 3.4], [154.1, 19.5], [179.2, 38.6], [198.3, 63.1], [216.7, 89.0],
    [228.0, 114.0], [220.0, 134.4], [194.5, 142.0], [163.5, 133.3], [135.1, 112.5],
    [110.4, 85.7], [85.1, 60.0], [55.5, 41.4], [22.3, 33.2], [-11.7, 35.9],
    [-45.6, 45.9], [-80.1, 56.0], [-114.7, 62.5], [-148.0, 69.6], [-179.8, 82.9],
    [-209.2, 98.5], [-227.8, 100.8], [-235.0, 90.2], [-222.6, 64.0], [-199.3, 35.3],
    [-171.5, 8.3],
  ],
  suzuka: [ // Suzuka — the esses, Dunlop, Degner, the hairpin, Spoon, 130R
    [-61.9, -2.1], [-95.2, -5.9], [-129.2, -12.0], [-162.7, -19.9], [-195.0, -30.3],
    [-222.3, -45.0], [-235.0, -62.0], [-227.3, -72.2], [-206.1, -66.9], [-180.3, -51.1],
    [-151.3, -39.6], [-120.9, -40.0], [-94.6, -45.7], [-75.6, -42.5], [-61.2, -25.5],
    [-28.5, -15.0], [-0.8, -30.4], [25.8, -50.0], [54.2, -66.6], [83.9, -73.1],
    [113.3, -65.8], [141.2, -46.8], [168.0, -22.6], [194.3, 2.5], [218.9, 28.5],
    [235.0, 54.2], [231.7, 69.5], [216.6, 73.1], [190.7, 60.4], [163.9, 42.8],
    [138.8, 24.3], [116.7, 4.5], [97.4, -16.9], [76.4, -34.0], [50.9, -36.5],
    [24.9, -23.0], [0.3, -3.8], [-25.0, 8.3], [-47.5, 2.7],
  ],
  nordschleife: [ // Nordschleife — a sprawling Eifel perimeter with the Karussell fold
    [151.7, -124.1], [172.6, -130.5], [191.5, -141.2], [211.9, -137.0], [230.3, -118.8],
    [235.0, -97.9], [223.2, -78.5], [206.9, -57.7], [191.6, -35.6], [172.0, -16.7],
    [147.1, -5.6], [125.8, 2.4], [118.6, 17.7], [114.9, 38.2], [98.6, 54.9],
    [74.4, 67.8], [50.3, 80.7], [26.4, 94.3], [2.6, 108.0], [-20.5, 123.4],
    [-41.1, 142.8], [-60.6, 159.9], [-82.1, 168.3], [-106.4, 171.0], [-132.6, 168.1],
    [-157.7, 157.6], [-180.4, 141.2], [-200.5, 121.6], [-212.5, 98.3], [-216.2, 71.7],
    [-221.8, 45.3], [-232.4, 21.6], [-235.0, 2.3], [-220.4, -13.9], [-201.4, -33.0],
    [-187.0, -56.0], [-170.9, -78.9], [-160.1, -101.2], [-158.1, -124.3], [-147.5, -142.2],
    [-125.0, -148.8], [-100.1, -149.6], [-76.3, -155.2], [-53.1, -166.3], [-30.3, -171.0],
    [-12.2, -161.5], [4.2, -144.8], [27.5, -134.4], [54.8, -129.0], [80.9, -122.4],
    [106.0, -122.2], [129.3, -125.3],
  ],
  monza: [ // Monza — long straights broken by chicanes, the Lesmos, Parabolica home
    [-43.7, 114.6], [-8.6, 113.5], [27.1, 112.7], [63.1, 112.5], [99.2, 112.4],
    [135.0, 111.4], [170.2, 109.2], [203.4, 103.6], [228.4, 91.3], [235.0, 73.2],
    [219.4, 57.6], [189.1, 50.1], [153.8, 48.3], [117.8, 48.1], [81.8, 47.6],
    [46.7, 45.2], [13.0, 39.2], [-18.5, 27.9], [-47.3, 10.3], [-74.3, -11.8],
    [-100.2, -35.9], [-124.2, -61.6], [-146.4, -87.3], [-170.0, -107.4], [-197.2, -115.1],
    [-222.2, -107.7], [-235.0, -87.5], [-232.5, -59.6], [-222.2, -28.8], [-212.3, 3.2],
    [-203.7, 35.8], [-192.2, 66.6], [-173.4, 91.5], [-146.2, 107.1], [-113.3, 113.6],
    [-78.6, 115.1],
  ],
  marina: [ // Singapore Marina Bay — right-angle street blocks under lights
    [181.6, -138.0], [170.3, -121.0], [170.2, -89.5], [170.6, -57.3], [157.7, -34.5],
    [128.8, -25.2], [91.8, -25.5], [54.1, -30.2], [18.2, -39.7], [-15.4, -54.3],
    [-47.2, -68.2], [-77.0, -70.9], [-104.2, -61.6], [-131.0, -53.9], [-158.3, -52.4],
    [-184.1, -43.6], [-206.3, -20.5], [-224.5, 10.1], [-235.0, 41.7], [-232.1, 71.9],
    [-216.9, 100.9], [-196.0, 126.3], [-175.0, 138.0], [-159.0, 126.6], [-149.2, 97.0],
    [-141.3, 61.3], [-130.5, 28.4], [-113.1, 8.6], [-87.6, 8.3], [-57.9, 21.9],
    [-29.6, 40.0], [-2.9, 55.8], [25.8, 61.8], [56.0, 57.5], [85.3, 53.5],
    [114.9, 58.0], [146.9, 66.8], [181.3, 70.1], [212.0, 61.0], [230.4, 37.3],
    [235.0, 3.5], [231.6, -33.7], [225.6, -70.7], [216.1, -105.3], [200.3, -131.3],
  ],
  panorama: [ // Mount Panorama — the climb, the ridge esses, the plunge, Conrod
    [223.8, -141.8], [229.9, -129.0], [218.5, -110.6], [197.6, -84.7], [193.3, -54.1],
    [208.7, -23.9], [227.8, 5.2], [235.0, 38.5], [228.0, 74.4], [208.5, 100.8],
    [177.1, 109.1], [139.4, 107.0], [104.1, 112.3], [74.0, 129.8], [46.6, 143.0],
    [23.4, 135.1], [3.8, 110.7], [-20.9, 86.3], [-55.5, 71.0], [-95.7, 65.0],
    [-137.8, 65.8], [-180.0, 69.2], [-216.5, 67.4], [-235.0, 54.0], [-226.7, 31.5],
    [-198.5, 7.4], [-164.2, -15.9], [-132.4, -41.7], [-104.8, -69.5], [-76.1, -91.1],
    [-41.5, -103.4], [-4.5, -115.1], [31.6, -128.4], [68.8, -135.5], [109.1, -136.2],
    [150.9, -138.5], [191.7, -143.0],
  ],
  ...
  oulton: [ // Oulton Park — parkland kidney with Old Hall, Island, the Hislops flick
    [81.5, 86.5], [114.4, 71.0], [148.5, 55.2], [182.2, 37.9], [212.3, 17.3],
    [231.7, -9.2], [235.0, -41.5], [224.3, -75.6], [204.3, -105.9], [177.3, -124.8],
    [147.5, -125.0], [120.9, -106.4], [99.3, -76.8], [79.4, -44.5], [57.6, -13.9],
    [32.7, 12.4], [5.4, 28.0], [-18.7, 23.8], [-34.0, -0.7], [-45.6, -34.2],
    [-63.6, -63.8], [-91.4, -81.1], [-125.5, -84.1], [-162.2, -78.1], [-198.4, -68.5],
    [-226.7, -54.1], [-235.0, -34.4], [-218.8, -18.3], [-188.1, -16.5], [-155.0, -25.9],
    [-125.1, -29.2], [-102.2, -13.5], [-87.7, 17.8], [-77.1, 54.2], [-64.1, 89.0],
    [-43.8, 115.2], [-15.1, 125.0], [17.7, 118.0], [50.0, 102.7],
  ],
  laguna: [ // Laguna Seca — the Andretti hairpin and the Corkscrew drop
    [103.0, -235.0], [150.7, -217.8], [190.6, -180.2], [219.5, -133.1], [227.4, -87.6],
    [204.9, -53.0], [158.3, -31.8], [103.4, -15.7], [51.4, 6.5], [10.7, 41.1],
    [-9.2, 87.3], [-3.0, 134.2], [27.3, 164.0], [72.4, 169.0], [115.5, 166.0],
    [128.3, 178.4], [115.2, 199.7], [69.4, 221.7], [13.2, 234.0], [-45.3, 235.0],
    [-103.5, 226.9], [-159.4, 213.4], [-205.9, 193.9], [-227.4, 163.8], [-220.2, 122.2],
    [-207.2, 73.8], [-211.0, 23.5], [-223.6, -25.5], [-220.0, -68.9], [-193.5, -106.0],
    [-154.3, -138.7], [-108.3, -166.9], [-56.9, -190.4], [-3.4, -211.7], [50.3, -229.8],
  ],
};
